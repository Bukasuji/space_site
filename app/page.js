...
export default function Home() {
  ...
  <main className="min-h-screen bg-cover bg-mobile md:bg-tablet xl:bg-desktop flex flex-col">
    ...
    <div className='xl:flex xl:mx-32 xl:mt-28'>
        ...
        <div className='bg-white h-[150px] w-[150px] md:h-[250px] md:w-[250px] mt-20 md:mt-48 xl:mt-40 mx-auto xl:ml-60 xl:mr-0 rounded-full  flex justify-center items-center'>
