    ...
    <div className='xl:flex xl:ml-40'>
        ...
        <div className='xl:flex xl:w-[50%] xl:mt-40'>
            ...
            <div className='xl:text-start text-center mt-4 md:mt-10 xl:mt-0 xl:ml-0'>
              ...
              <p className='font-sans text-white text-2xl md:text-4xl xl:text-5xl uppercase mt-2 md:mt-4'>SPACEPORT</p>
              <p className='text-[#D0D6F9] font-base xl:text-lg font-barlow font-normal mx-6 mt-4 md:w-[47%] md:mx-auto xl:mx-0 xl:w-[444px]'>A spaceport or cosmodrome is a site for launching (or receiving) spacecraft, by analogy to the seaport for ships or airport for aircraft. Based in the famous Cape Canaveral, our spaceport is ideally situated to take advantage of the Earth’s rotation for launch.</p>
            </div>
        </div>
