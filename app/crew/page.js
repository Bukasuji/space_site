...
export default function Crew() {
  ...
  <main className="min-h-screen flex flex-col bg-cover xl:bg-[url('/assets/crew/background-crew-desktop.jpg')] md:bg-[url('/assets/crew/background-crew-tablet.jpg')] bg-[url('/assets/crew/background-crew-mobile.jpg')]">
    <Navbar/>
    <div className='xl:flex xl:mx-40 xl:mt-20 xl:mb-0'>
        <div className='flex justify-center xl:justify-start flex-col xl:w-[70%]'>
            ...
            <div className='text-center xl:text-start mt-10 md:mt-14 xl:mt-32 hidden md:block'>
              <p className='font-sans text-base md:text-2xl xl:text-3xl md:mb-4 text-white opacity-40 uppercase'>Commander </p>
              <p className='font-sans text-white text-2xl md:text-[40px] xl:text-5xl uppercase'>Douglas Hurley</p>
              <p className='text-[#D0D6F9] xl:text-lg font-normal font-base font-barlow mx-6 mt-4 md:w-[60%] xl:w-[444px] md:mx-auto xl:mx-0'>Douglas Gerald Hurley is an American engineer, former Marine Corps pilot and former NASA astronaut. He launched into space for the third time as commander of Crew Dragon Demo-2. </p>
            </div>
        ...
        <div className='flex justify-center'>
            ...
            <div className='text-center mt-4 md:hidden'>
              <p className='font-sans text-base text-white opacity-40 uppercase'>Commander </p>
